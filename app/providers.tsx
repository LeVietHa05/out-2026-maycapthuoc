...
const translations = {
    vn: {
        ...
        listPlaceholderTitle: 'Trang danh sách thuốc  ',
        listPlaceholderDescription: 'Hiển thị danh sách thuốc và giỏ hàng.',
    ...
    en: {
        ...
        listPlaceholderTitle: 'Medicine list page ',
        listPlaceholderDescription: 'Show the medicine list and shopping cart.',
